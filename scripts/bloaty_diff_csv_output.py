#!/usr/bin/python3
#
# This script takes two csv bloaty output files as input and generates a file
# containing a summary of the diff. This file is in a markdown format and its
# contents are used as a pull request comment.
